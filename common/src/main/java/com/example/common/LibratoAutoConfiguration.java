...
public class LibratoAutoConfiguration {
	...
	@Bean
	@ExportMetricWriter
	public LibratoMetricWriter libratoMetricWriter(LibratoProperties librato) {
		return new LibratoMetricWriter(new DefaultHttpPoster(librato.getUrl(),
				librato.getEmail(), librato.getToken()), librato);
	}
